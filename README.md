...
## Description
This package implements a node that can connect to a ELRS radio and produce a sensor_msgs::Joy topic to be used for teleoperation.

Sources used for the protocol definition:
...
If you are familiar with ROS 2, here are the quick-and-dirty build instructions.
  ...
  git clone git@github.com:alessiomorale/elrs_joy.git src/elrs_joy
  vcs import src --input src/elrs_joy/elrs_joy.jazzy.repos
  vcs import src --input src/elrs_joy/elrs_joy.jazzy.upstream.repos
...
### Packages in `elrs_joy` metapackage
* **elrs_joy_crsf_node** - CRSF joy node for ELRS
* **elrs_joy_crsf_protocol** - crsf protocol handling for ELRS
